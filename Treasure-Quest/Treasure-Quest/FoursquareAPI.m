...
+(void)getFoursquareData:(NSString *)userData finalLat:(NSString *)finalLat finalLong:(NSString *)finalLong completionHandler:(foursquareFetchCompletion)completionHandler
{
    ...
    //NSString *v = @"20160613";
   // NSString *venueID = "";
    NSString *searchURL = [NSString stringWithFormat:@"%@search?ll=%@,%@&client_id=%@&client_secret=%@&v=20160613&radius=1000&categoryId=4d4b7105d754a06374d81259", BaseURLString, finalLat, finalLong, clientID, clientSecret];
